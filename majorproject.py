...
training = pd.read_csv('/home/student/Desktop/Training.csv')
testing = pd.read_csv('/home/student/Desktop/Testing.csv')
...
def getDescription():
    ...
    with open('/home/student/Desktop/symptom_Description.csv') as csv_file:
...
def getSeverityDict():
    ...
    with open('/home/student/Desktop/Symptom_severity.csv') as csv_file:
        csv_reader = csv.reader(csv_file, delimiter=',')
        for row in csv_reader:
            if len(row) >= 2:
...
def getprecautionDict():
    ...
    with open('/home/student/Desktop/symptom_precaution.csv') as csv_file:
        csv_reader = csv.reader(csv_file, delimiter=',')
        for row in csv_reader:
...
def sec_predict(symptoms_exp):
    df = pd.read_csv('/home/student/Desktop/Training.csv')
    X = df.iloc[:, :-1]
    y = df['prognosis']
...
print("Thank you for using the Aayush Arogya ChatBot!")
